...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(WebSignalR.App_Start.HtmlMicrodataFormatterActivator), "ConfigureHtmlMicrodataFormatter")]

// This part configures routes that generate documentation, forms and links for your project at ~/api and ~/api/doc/{typeName}:
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(WebSignalR.App_Start.HtmlMicrodataFormatterActivator), "ConfigureDocumentationProvider")]
...
namespace WebSignalR.App_Start
{
    public static class HtmlMicrodataFormatterActivator
    {
        ...
        private static MediaTypeFormatter CreateHtmlMicrodataFormatter(HttpConfiguration config)
        {
            ...
            formatter.AddHeadContent(new XElement("title", "WebSignalR"));
